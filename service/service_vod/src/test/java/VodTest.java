...
public class VodTest {
    ...
    private final static String VIDEO_ID = "5452056b8fba4ed5b6bb4e9d01d3e130";
    private final static String REGION_ID = "cn-shanghai";
    ...
    public void testUpload() throws ClientException {
        String title = "测试标题";
        String fileName = "D:/testUpload.mp4";
        //本地文件上传
        testUploadVideo(title, fileName);
    }

//    @Test
//    public void testGetVideo() throws ClientException {
//
//        // 获取client
//        DefaultAcsClient client = VodClientFactory.getVodClient();
//        // 获取response
